...
parse(P, varargin{:});
P = P.Results;
[intrinsicspeed, X, Y] = common.intrinsic_flow_speed(hypothesis, 'Delta_scale', P.Delta_scale);
[inputspeed, X2, Y2] = common.input_flow_speed(hypothesis, 'Delta_scale',  P.Delta_scale, ...
