...
parse(P, varargin{:});
P = P.Results;
[X,Y,Xdot_L,Ydot_L] = common.flows(hypothesis, 'leftinput', 'Delta_scale', P.Delta_scale, ...
    'apply_default_scale', P.apply_default_scale);
[~,~,Xdot_R,Ydot_R] = common.flows(hypothesis, 'rightinput', 'Delta_scale', P.Delta_scale, ...
    'apply_default_scale', P.apply_default_scale);
