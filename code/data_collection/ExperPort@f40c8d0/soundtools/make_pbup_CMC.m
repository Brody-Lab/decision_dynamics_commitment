% [snd lrate rrate data] = make_pbup_CMC(R, g, srate, T, varargin)
%
% Makes Poisson bups
...
function [snd, lrate, rrate, data] = make_pbup_CMC(srate, T, Rrate, Lrate, varargin)
...
% 	end;
    ...
    %%CHRISTINE COMMENTED THIS OUT.  THIS IS THE ONLY CHANGE THAT I MADE!
    rrate = Rrate;
    lrate = Lrate;
% 	rrate = R/(exp(-g)+1);
% 	lrate = R - rrate;
