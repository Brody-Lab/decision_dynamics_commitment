...
%% next_trial
  case 'next_trial'  
      ...
      %determine based on fixed fraction whether this trial will be fixed interval or not
      is_fixed.value = value(fixed_frac)>rand; %WS: edit 8/17 because was inverse coded before
