...
%                   'r' represents 'right would be correct' first element
...
%                   'left would be correct', 'r' represents 'right would be correct' 
%                   first element  corresponds to first trial.
% 
...
%                   'l's and 'r's and of length n_done_trials where 'l'
%                   represents 'left would be correct', 'r' represents 'right would
%                   be correct' first element corresponds to first trial.
%
