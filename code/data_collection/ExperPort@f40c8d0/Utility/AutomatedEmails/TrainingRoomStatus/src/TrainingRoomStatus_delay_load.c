 ...
 */
FARPROC WINAPI TrainingRoomStatusDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = TrainingRoomStatusDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = TrainingRoomStatusDelayLoadWin32FailureHook;
#endif
