    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_Room_Turnover_Indicator.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    NOTE: Room_Turnover_Indicator.ctf will be present only if you have chosen 
    ...
    All Platforms:
        * Room_Turnover_Indicator.ctf (if present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * Room_Turnover_Indicator.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * Room_Turnover_Indicator (application created by MATLAB Compiler)
        * run_Room_Turnover_Indicator.sh (shell script that can be run to 
    ...
    All Platforms:
        ...
        * Room_Turnover_Indicator.dll (shared library, file extension varies by 
          platform)
        * Room_Turnover_Indicator.h (library header file)
    ...
    Windows:
        * Room_Turnover_Indicator.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)    
        * Room_Turnover_Indicator.xml (documentation files)
        * Room_Turnover_Indicator.pdb (program database file - if DEBUG option 
          selected)
        * Room_Turnover_Indicator.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    Windows:
        * Room_Turnover_Indicator.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * Room_Turnover_Indicator_1_0.dll (COM component)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)      
    ...
    All Platforms: 
        * Room_Turnover_Indicator.jar (Java class files and compiled M-code)
    ...
    Windows:
        * Room_Turnover_Indicator.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * Room_Turnover_Indicator_1_0.dll (COM component)
        * Room_Turnover_Indicator.xla (optionally created and placed in
          C:\ratter\ExperPort\Utility\Room_Turnover_Indicator\src directory by the user)  
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
