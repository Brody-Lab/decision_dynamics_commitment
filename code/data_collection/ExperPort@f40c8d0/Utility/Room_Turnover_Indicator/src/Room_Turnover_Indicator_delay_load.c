 ...
 */
FARPROC WINAPI Room_Turnover_IndicatorDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = Room_Turnover_IndicatorDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = Room_Turnover_IndicatorDelayLoadWin32FailureHook;
#endif
