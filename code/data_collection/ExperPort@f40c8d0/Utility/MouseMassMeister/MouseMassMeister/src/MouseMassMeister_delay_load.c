 ...
 */
FARPROC WINAPI MouseMassMeisterDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = MouseMassMeisterDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = MouseMassMeisterDelayLoadWin32FailureHook;
#endif
