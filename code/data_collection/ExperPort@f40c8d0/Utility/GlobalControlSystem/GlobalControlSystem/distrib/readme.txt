    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_GlobalControlSystem.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    NOTE: GlobalControlSystem.ctf will be present only if you have chosen 
    ...
    All Platforms:
        * GlobalControlSystem.ctf (if present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * GlobalControlSystem.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * GlobalControlSystem (application created by MATLAB Compiler)
        * run_GlobalControlSystem.sh (shell script that can be run to 
    ...
    All Platforms:
        ...
        * GlobalControlSystem.dll (shared library, file extension varies by 
          platform)
        * GlobalControlSystem.h (library header file)
    ...
    Windows:
        * GlobalControlSystem.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)    
        * GlobalControlSystem.xml (documentation files)
        * GlobalControlSystem.pdb (program database file - if DEBUG option 
          selected)
        * GlobalControlSystem.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    Windows:
        * GlobalControlSystem.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * GlobalControlSystem_1_0.dll (COM component)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)      
    ...
    All Platforms: 
        * GlobalControlSystem.jar (Java class files and compiled M-code)
    ...
    Windows:
        * GlobalControlSystem.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * GlobalControlSystem_1_0.dll (COM component)
        * GlobalControlSystem.xla (optionally created and placed in
          C:\ratter\ExperPort\Utility\GlobalControlSystem\GlobalControlSystem\src directory by the user)  
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
