...
%         stimline2 = bSettings('get', 'DIOLINES', 'cerebro1');
...
%         lp = StimulationSection(obj,'get_all');
        ...
        r = rand;
        if r < value(p_both_stim) % Both Stim
...
%         
%         sma = add_state(sma,'name','wait_for_cpoke',...
%             'self_timer',min_time,'output_actions',{'SchedWaveTrig','+stimulatorwave'},...
%             'input_to_statechange',{'Clo',wait_for_cpoke2}); %wait for poke out
%         

        sma = add_state(sma,'name','wait_for_cpoke',...
            'self_timer',min_time,...
            'input_to_statechange',{'Clo',laser_state}); %wait for poke out
                
        
        sma = add_state(sma,'name','laser_state_on',...
            'self_timer',0.1,...
            'output_actions',{'DOut', +cerebro2 },...
            'input_to_statechange',{'Tup',wait_for_cpoke2}); 
                
        
        sma = add_state(sma,'name','laser_state_off',...
            'self_timer',0.1,...
            'output_actions',{'DOut', -cerebro2 },...
            'input_to_statechange',{'Tup',wait_for_cpoke2});
        ...
        sma = add_state(sma,'name','wait_for_cpoke_dir',...
            'self_timer',0.5,...
            'output_actions',{'SoundOut',task_sound_id;'DOut', centerlight-cerebro2 },...
            'input_to_statechange',{'Tup',laser_indicator_state});
        ...
        sma = add_state(sma,'name','both_stim_indicator','self_timer',min_time,'input_to_statechange',{'Tup','wait_for_cpoke_bis'});
        sma = add_state(sma,'name','no_stim_indicator','self_timer',min_time,'input_to_statechange',{'Tup','wait_for_cpoke_bis'});
        ...
        sma = add_state(sma, 'name', 'cpoke', 'self_timer', min_time, ...
            ...
            'SoundOut',stimulus_sound_id; 'DOut', centerlight2}, ...
...
%             'output_actions',{'SchedWaveTrig','stimulatorwave_off';'SoundOut',-stimulus_sound_id},...
...
%             'output_actions',{'SchedWaveTrig','stimulatorwave_off';'SoundOut',err_sound_id},...
%             'input_to_statechange',{'Tup','clean_up_state'});
...
%         sma = add_state(sma,'name','nic_error_state','self_timer',min_time,...
%             'output_actions',{'SchedWaveTrig','-stimulatorwave'},...
%             'input_to_statechange',{'Tup','nic_error_state2'});
%         
        ...
        sma = add_multi_sounds_state(sma,[-stimulus_sound_id viol_sound_id],...
            ...
            'state_name','nic_error_state2','return_state','clean_up_state');
