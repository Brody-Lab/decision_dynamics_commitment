...
switch action,
    ...
    case 'init'
        ...
        SoloParamHandle(obj, 'left_laser_history', 'value',[]);
        SoloParamHandle(obj, 'right_laser_history', 'value',[]);
...
%         
        ...
        SoloFunctionAddVars('StimulusSection', 'ro_args',{'hit_history';'side_history';'quadrant_history';'task_history';...
            'incoh_history';'gammadir_history';'gammafreq_history';'result';'left_laser_history';'right_laser_history'});        
        SoloFunctionAddVars('StimulusSection', 'rw_args',{'was_block_switch'});
        
        %to protocol
        SoloFunctionAddVars('TaskSwitch4double', 'ro_args',{'hit_history';'side_history'});
    ...
    case 'next_trial',
        ...
        %%%% LEFT LASER HISTORY %%%%
        left_laser_history.value=[value(left_laser_history) value(laser_left_on)];
        
        %%%% RIGHT LASER HISTORY %%%%
        right_laser_history.value=[value(right_laser_history) value(laser_right_on)];
