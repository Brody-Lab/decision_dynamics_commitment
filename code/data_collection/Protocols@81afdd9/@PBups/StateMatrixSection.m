...
%% set up center_pokes
    is_rat_being_simulated = PBupsSection(obj, 'check_is_rat_being_simulated');
    if is_rat_being_simulated
        first_state = 'play_stimulus_sound';
        after_cpoke1 = 'simulated_response_state';
    elseif nose_in_center == 0
        first_state = 'play_stimulus_sound';
...
%% center to side gap
    ...
    sma = add_state(sma, 'name', 'center_2_side_gap', ...
        ...
        'input_to_statechange', {'Tup', 'current_state+1'});
    if strcmp(StimulusSpecs.stim_timing, 'During Cpoke Only') && ~is_rat_being_simulated
...
%% reward states
    ...
    if rand > 0.5
        simulatedchoice = LeftResponseState;
    else
        simulatedchoice = RightResponseState;
    end
    sma = add_state(sma, 'name', 'simulated_response_state', ...
                         'self_timer', nose_in_center, ...
        'input_to_statechange', {'Tup', simulatedchoice});
