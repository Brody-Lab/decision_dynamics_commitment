%ProspectFlickerPbups, cmc 2/6/16

function [obj] = ProspectFlickerPbups(varargin)
...
switch action,
   ...
   case 'init'
      ...
      HeaderParam(obj, 'prot_title', ['ProspectFlickerPbups: ' expmtr ', ' rname], ...
         x, y, 'position', [10 figpos(4)-25, 800 20]);
      
      
    %  SMA1(obj, 'init');
     
      ProspectFlickerPbups(obj, 'prepare_next_trial');
   ...
   case 'prepare_next_trial'
    ...
    %  TrainingSection(obj, 'next_trial');
      ...
      if n_done_trials==1
      [expmtr, rname]=SavingSection(obj, 'get_info');
      prot_title.value=['Flickr - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
      end
    %  [sma] = StimulatorSection(obj, 'update_values', sma);
      
      [sma] = SMA1(obj,'next_trial');
