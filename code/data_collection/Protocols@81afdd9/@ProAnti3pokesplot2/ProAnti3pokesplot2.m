...
function [obj] = ProAnti3pokesplot2(varargin)
...
%% INIT 
  case 'init'
    ...
    NumeditParam(obj, 'StimDelay',   0,x,y,                                            'position',[x     y 100 20]);
    ToggleParam(obj,  'StimTime',    1,x,y,'OnString','PostStim','OffString','NICStim','position',[x+100 y 100 20]);  next_row(y);
    NumeditParam(obj, 'MemoryZap',   0,x,y,'labelfraction',0.5); next_row(y,1.3);
...
%% prepare_next_trial    
  ...
  case 'prepare_next_trial'
    ...
    cpt = value(cpoketry);    cpt = cpt(1:length(hh));
