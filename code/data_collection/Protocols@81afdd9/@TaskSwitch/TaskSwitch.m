% TaskSwitch protocol
% Marino Pagan, May 2015

function [obj] = TaskSwitch(varargin)
...
%         set(value(myfig), 'Position', [400 100 850 540]);
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-25, 800 20]);

    
        TaskSwitch(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
        end
