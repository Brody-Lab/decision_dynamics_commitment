...
switch action,
  ...
  case 'init'
    ...
    set(gcf, 'Visible', 'off');
    x=10;y=10;
    [x,y]=SoundInterface(obj,'add','ViolationSound',x,y,'Volume',0.01,'Freq',8000); 
    [x,y]=SoundInterface(obj,'add','ErrorSound',x,y,'Style','WhiteNoise','Volume',0.08);
    [x,y]=SoundInterface(obj,'add','TimeoutSound',x,y,'Style','WhiteNoise','Volume',0.08);
    next_column(x);
    y=10;
    [x,y]=SoundInterface(obj,'add','NICSound',x,y,'Style','WhiteNoise','Volume',0.08);
    [x,y]=SoundInterface(obj,'add','HiNICSound',x,y,'Style','WhiteNoise','Volume',0.08);

    [x,y]=SoundInterface(obj,'add','HitSound',x,y,'Style','ToneSweep','Volume',0.02);
