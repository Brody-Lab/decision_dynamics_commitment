...
%% init    
  case 'init',
      ...
      next_row(y);
      SoloParamHandle(obj,'max_nic_previous_day','value',0,'save_with_settings',1);
      ...
      next_row(y);
      MenuParam(obj, 'side_lights', {'correct side only', 'both sides on', 'both sides off', 'anticorrect side only', 'correct side from fixation onset'}, ...
          1, x, y, ...
          'labelfraction', 0.4, ...
      ...
      DistribInterface(obj, 'add', 'rt_stim_delay', x, y, 'Style', ...
                    'exponential', 'Min', 0.2, 'Max', 2, 'Tau',2, ...
