...
%% INIT 
  case 'init'
    ...
    set(value(myfig), 'Position', [700 600 350 350]);

    x = 5; y = 5;
    
    [x, y] = SavingSection(obj,       'init', x, y); 
    NumeditParam(obj, 'Valve_Open_Time',    0.2, x, y, 'labelfraction', 0.6); next_row(y);
    NumeditParam(obj, 'InterPulseInterval', 0.5, x, y, 'labelfraction', 0.6); next_row(y,1.5);
    
    NumeditParam(obj, 'Number_Pulses',        1, x, y, 'labelfraction', 0.6); next_row(y,1.5);
