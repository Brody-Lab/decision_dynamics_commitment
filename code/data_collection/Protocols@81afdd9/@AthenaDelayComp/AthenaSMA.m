...
switch action
	...
	case 'prepare_next_trial',
        ...
        % to modify it for widefield imaging
		...
		switch value(training_stage)
			...
			case 1  %%  center led on -> poke in the center -> go cue -> reward light and sound -- waiting time grows slowly -stimuli can be present
