...
% ----------------------------------------------------------------
  ...
  case 'init', 
      ...
      MenuParam(obj,'StimInterval',{'WholeTrial','S1','DelayDur','S2','WholeTrialPULSED'},1,x,y,'labelfraction',0.30); next_row(y);
      ...
      NumeditParam(obj,'Pulse',10,x,y,'position',[x     y 100 20],'labelfraction',0.60);
      next_row(y);
      
      DispParam(obj,'SD',0 ,x,y,'position',[x     y 40 20],'labelfraction',0.4);
      DispParam(obj,'SF',20,x,y,'position',[x+40  y 40 20],'labelfraction',0.4);
      DispParam(obj,'PW',15,x,y,'position',[x+80 y 40 20],'labelfraction',0.4);
      DispParam(obj,'NP',1,x,y,'position',[x+120 y 40 20],'labelfraction',0.4);
      DispParam(obj,'PS',10,x,y,'position',[x+160 y 40 20],'labelfraction',0.4); next_row(y);
  ...
  case 'prepare_next_trial',
      ...
      for i = 1:length(sl)
          ...
          sma = add_scheduled_wave(sma,...
              ...
              'preamble',      (1/sf)-(ps/1000),... %%%% Remember: change it such that if this is negative makes it 0
              'sustain' ,      ps/1000,...
              'DOut',          stimline,...
              'loop',          floor(np*sf)-1);
      ...
      for i = 1:length(sl)
          if sh(end) == 1
              if strcmp(value(StimState),'none') == 0
                  ...
                  SD.value = sd; SF.value = sf; PW.value = pw; NP.value = np;  PS.value=ps;
              end
          else
              SD.value = 0; SF.value = 0; PW.value = 0; NP.value = 0; PS.value=0;
          end
      end
  ...
  %% Case StimInterval  
    case 'StimInterval'
        ...
        if strcmp(StimInterval, 'WholeTrial');
            ...
            Pulse.value = Total_CP_duration*1000 + 2000;
        elseif strcmp(StimInterval, 'S1');
            PulseWidth.value = A1_time*1000;
            StimFreq.value = 1000/PulseWidth;
            StartDelay.value = PreStim_time;
            Pulse.value = A1_time*1000;
        elseif strcmp(StimInterval, 'S2');
            ...
            Pulse.value = (A2_time+time_bet_aud2_gocue+time_go_cue)*1000+2000;
        elseif strcmp(StimInterval, 'DelayDur');
            PulseWidth.value = A1_time*1000;
            StimFreq.value = 1000/PulseWidth;
            StartDelay.value = PreStim_time + A1_time*2;
            Pulse.value = A1_time*1000;
        elseif strcmp(StimInterval, 'WholeTrialPULSED');
            PulseWidth.value = Total_CP_duration*1000 + 2000;
            StimFreq.value = 20;
            Pulse.value = 10;
            StartDelay.value = PreStim_time;
