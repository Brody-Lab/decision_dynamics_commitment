...
function [obj] = FixedDelayedOrientingChristine(varargin)
...
switch action,
   ...
   case 'init'
    ...
    DeclareGlobals(obj, 'ro_args', {'thisside', ...
        'RandomizePressure','ProbMaxPressure', 'StepSize', 'pair_history'});
   ...
   case 'prepare_next_trial'
	   try
		   ...
		   if have_i_crashed_yet==0, %#ok<*NODEF>
			   ...
			   save('../Protocols/@FixedDelayedOrientingChristine/crash_report');
		   end;
	   end;
