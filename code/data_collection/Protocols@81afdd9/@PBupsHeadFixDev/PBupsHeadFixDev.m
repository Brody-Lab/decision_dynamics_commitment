...
%     hackvar = 10; SoloFunctionAddVars('SessionModel', 'ro_args', 'hackvar'); %#ok<NASGU>
    ...
    SoloParamHandle(obj, 'active_curricula', 'value',...
        {'ws_headfix_gocue_first_v2','ws_headfix_gocue_first_v3','ws_headfix_gocue_first','ws_headfix_gocue_v4','ws_headfix_gocue_block_rule_v2','ws_headfix_gocue_block_rule'});
    ...
    SoloFunctionAddVars('RewardsSection', 'rw_args', {'timeout_history', 'hit_history','violation_history'});
    ...
    [x, y] = PokesPlotSection(obj, 'init', x, y, ...
      struct('states',  SC));
    PokesPlotSection(obj, 'set_alignon', 'iti(1,2)');
...
%         SessionDefinition(obj, 'next_trial');
    ...
    elseif strcmp(varargin{1},'crashed')
        ...
        if value(n_prepped_trials) < value(n_started_trials)
            ...
            timeout_history.value      = [timeout_history(:)     ; nan];
            violation_history.value    = [violation_history(:)   ; nan];
