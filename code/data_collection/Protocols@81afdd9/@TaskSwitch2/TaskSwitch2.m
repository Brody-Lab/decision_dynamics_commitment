% TaskSwitch2 protocol
% Marino Pagan, June 2015

function [obj] = TaskSwitch2(varargin)
...
%         set(value(myfig), 'Position', [400 100 850 700]);
        set(value(myfig), 'Position', [400 100 850 540]);
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch2: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-25, 800 20]);

    
        TaskSwitch2(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        %%% set up task for next trial
        TaskSection(obj, 'next_trial');
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch2 - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
    ...
    case 'end_session'
%         CommentsSection(obj, 'append_line', ['This is a test.   ' datestr(now)]);
