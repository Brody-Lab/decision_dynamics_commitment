...
switch action,
	...
	case 'init'
        ...
        NumeditParam(obj, 'A1_time', 0.03, x,y,'label','AUD1 on Time','TooltipString','Duration of first stimulus');
        next_row(y);
        set_callback(A1_time, {mfilename, 'new_CP_duration'});
        NumeditParam(obj, 'A2_time', 0.03, x,y,'label','AUD2 On Time','TooltipString','Duration of second stimulus');
        next_row(y);
