...
function [obj] = Rigtestlongtime(varargin)
...
switch action,
  ...
  case 'init'
    ...
    my_state_colors = struct( ...
      ...
      'in_left',          [0.5 0.5 1],   ...
      'wait_for_center',  [1 1 0], ...
      'in_center',        [0.5 1 0.5],   ...
      'wait_for_right',   [0 1 1], ...
      'in_right',         [1 0.5 0.5],   ...
      'state_0',                [1 1 1],       ...
      'final_state',            [0.5 0 0],     ...
...
%         'Balance',1); next_row(y);
  ...
  case 'prepare_next_trial'
    ...
    %     Left
    sma = add_state(sma, 'name', 'wait_for_left','self_timer',2140, ...
    ...
    %     Center    
    sma = add_state(sma, 'name', 'wait_for_center','self_timer',2150, ...
        'input_to_statechange', { ...
        'Cin', 'in_center', ...
        'Lin', 'wfc_in_left', ...
        'Rin', 'wfc_in_right', ...
    ...
    %     Right
    sma = add_state(sma, 'name', 'wait_for_right','self_timer',2160, ...
        'input_to_statechange', { ...
        'Rin', 'in_right', ...
        'Cin', 'wfr_in_center', ...
        'Lin', 'wfr_in_left', ...
