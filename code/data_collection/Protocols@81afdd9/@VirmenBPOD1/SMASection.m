...
switch action
    ...
    case 'prepare_next_trial'
        ...
        ac_stimuli = value(solo_ac_stimuli);
        if ac_stimuli.trialType == Choice.R
       ...
       sma = add_state(sma, 'name', 'in_start', ...
            'output_actions', {'PCLink1Out', 1}, ...
             'input_to_statechange', { 'PCLink1_3', 'in_cues' });
         
       sma = add_state(sma, 'name', 'in_cues', ...
             'input_to_statechange', { 'PCLink1_4', 'in_memory' });
         
       sma = add_state(sma, 'name', 'in_memory', ...
             'input_to_statechange', { 'PCLink1_5', 'in_turn' });
        
        sma = add_state(sma, 'name', 'in_turn', ...
            'input_to_statechange', { 'PCLink1_7', left_answer
                                      'PCLink1_8', right_answer});
