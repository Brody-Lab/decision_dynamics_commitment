...
switch action
    ...
    case 'init'
        ...
        tcp_client = VirmenBControl.initialize_comm();

        % Read protocol file and generate all virmen structures
        protocol_file = fullfile(mfilename('fullpath'), 'VirmenBPOD1_protocol_file.m');
        [virmen_structure, codes_files] = ...
            VirmenBControl.virmen_structure_gen.generate_Virmen_structures(protocol_file);
        ...
        % Get example session
        path_session = 'C:\ratter\Protocols\@VirmenBPOD1\virmen_test_session2.mat';
        ...
        SoloParamHandle(obj, 'solo_ac_stimuli',   'value', 0);
        ...
        SoloParamHandle(obj, 'solo_comm_idx',   'value', 0);
        SoloParamHandle(obj, 'solo_single_vars',   'value', single(zeros(10000,7)));
        
        SoloParamHandle(obj, 'solo_virmen_structure', 'value', virmen_structure)
        ...
        DeclareGlobals(obj, 'ro_args', {'hit_history',           ...
                                        ...
                                        'solo_tcp_client',       ...
                                        'solo_ac_stimuli',       ...
                                        'solo_virmen_structure'});
        
        SoloFunctionAddVars('HitSection',   'rw_args', 'hit_history');
        SoloFunctionAddVars('HitSection',   'rw_args', 'solo_ac_stimuli');
