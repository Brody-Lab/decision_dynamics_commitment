...
%         
        sma = add_state(sma, 'name', 'wait1', 'self_timer',0.3, ...
            ...
            'input_to_statechange', { 'Tup', 'send_back1' });
        
        sma = add_state(sma, 'name', 'send_back1', ...
            'output_actions', {'PCLink1Out', 3}, ...
            'input_to_statechange', { 'PCLink1_3', 'send_back2' });
        
         sma = add_state(sma, 'name', 'send_back2', ...
            'output_actions', {'PCLink1Out', 4}, ...
            'input_to_statechange', { 'PCLink1_4', 'send_back3' });
        
        sma = add_state(sma, 'name', 'send_back3', ...
            'output_actions', {'PCLink1Out', 5}, ...
            'input_to_statechange', { 'PCLink1_5', 'send_back5' });
        
%         sma = add_state(sma, 'name', 'send_back4', ...
%             'output_actions', {'PCLink1Out', 6}, ...
%             'input_to_statechange', { 'PCLink1_6', 'send_back5' });
        
        sma = add_state(sma, 'name', 'send_back5', ...
            'output_actions', {'PCLink1Out', 7}, ...
            'input_to_statechange', { 'PCLink1_7', 'final_state' 
