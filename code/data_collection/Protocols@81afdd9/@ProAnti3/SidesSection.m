...
%% init  
  case 'init',
    ...
    ToggleParam( obj, 'LightAndSound',      0,    x, y, 'position',[x    y 200 20], 'OnString','Light_AND_Sound','OffString','Light_OR_Sound'); next_row(y);
    MenuParam( obj, 'PostCueType',{'None','Both','Random','Opposite'},1,x,y,'position',[x    y 200 20], 'labelfraction',0.6); next_row(y);
    ...
    set(value(myaxes), 'Position', [90 pos(4)-110 pos(3)-130 80]);
    ...
    SoloFunctionAddVars('SMASection',  'ro_args', {'ThisTrial_Side','ThisTrial_Type','ThisTrial_Stim','ThisTrial_Mem','ThisTrial_Free','LightAndSound','PostCueType'});
