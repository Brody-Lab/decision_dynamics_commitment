...
%% init    
  case 'init'
    ...
    %this saves the position on the main ProAnti3 screen so we can return there
...
%antibias section - L_HitFrac R_HitFrac
[Left_volume,Right_volume]=WaterValvesSection(obj,  'get_water_volumes');
wateramnt = (value(L_HitFrac)*value(Left_volume)) + (value(R_HitFrac)*value(Right_volume));
