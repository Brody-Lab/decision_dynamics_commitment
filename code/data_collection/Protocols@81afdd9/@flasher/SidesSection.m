...
switch action,
    ...
    case 'init'
        ...
        next_row(y);
        ToggleParam(obj, 'rewards_from_spokes', 1, x,y,'OnString','Side Rewards','OffString','Center Rewards','TooltipString','Are rewards given in side ports or center ports.  ');
        next_row(y);
        ...
        MenuParam(obj, 'gap_type' ,{'none','both','left','right'},1, x,y,'label','Gap Type','TooltipString','Where is the gap? (Or is their none)');
        next_row(y);
        NumeditParam(obj, 'gap_dur', .4, x,y,'label','Gap duration','TooltipString','Duration of gap.  Smaller is harder');
        next_row(y);
        NumeditParam(obj, 'flash1_dur', .4, x,y,'label','Flash1 Duration','TooltipString','Duration of first flash');
        next_row(y);
        NumeditParam(obj, 'waitforgo_dur', 0.3, x,y,'label','Wait for Go Dur','TooltipString','Max time allowed for cpoke out after gap onset ');
        next_row(y);
        NumeditParam(obj, 'waitfornogo_dur', 0.3, x,y,'label','Wait for NoGo Dur','TooltipString','Max time allowed for cpoke out after nogo trial leds off');
        next_row(y);
        ...
        SoloFunctionAddVars('SMA1', 'ro_args', ...
            ...
            'gap_type'; 'gap_dur'; ...
            'rewards_from_spokes';'side_reward_loc';...
            'flash1_dur'; 'wait_for_cpoke_timeout'; 'allow_nic_breaks' ; ...
            'waitforgo_dur'; 'waitfornogo_dur'; 'high_rew_mult';...
        ...
        SoloFunctionAddVars('SMA_train', 'ro_args', ...
            {'short_iti_dur';...
            'rewards_from_spokes';'side_reward_loc';...
            'flash1_dur'; 'wait_for_cpoke_timeout'; ...
            'waitforgo_dur'; ...
    ...
    case 'next_trial',
        ...
        %% Need to think more about antibias
        ...
        if use_training==1
            ...
            switch value(training_stage) %#ok<*NODEF>
                ...
                case 2,
                    ...
                    if trials_in_stage<1501
                        flash1_dur.value=trials_in_stage/1000+0.001;
                    end
