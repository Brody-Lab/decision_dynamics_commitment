%ProspectFlicker, cmc 2/6/16

function [obj] = ProspectFlicker(varargin)
...
switch action,
   ...
   case 'init'
      ...
      HeaderParam(obj, 'prot_title', ['ProspectFlicker: ' expmtr ', ' rname], ...
         x, y, 'position', [10 figpos(4)-25, 800 20]);
      
      ProspectFlicker(obj, 'prepare_next_trial');
