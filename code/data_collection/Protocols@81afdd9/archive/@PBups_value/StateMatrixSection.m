...
switch action
    ...
    case 'next_trial',
        ...
        if SidesSection(obj, 'get_current_side') == 'l',                  % Left is the correct response
            ...
            if ~value_task                                  % set up rewards and punishments for percept task
            ...
            else                                                % set up the rewards for the value task
                if strcmp(value(reward_timing), 'from spoke'),
                    LeftResponseState = 'correct_reward';
                    RightResponseState = 'incorrect_reward';
                elseif strcmp(value(reward_timing), 'from cpoke'),
                    LeftResponseState = 'hit_state';
                    RightResponseState = 'err_state';
                else
                    warning('StateMatrixSection:Invalid', 'doesn''t know reward timing!');
                    return;
                end;
        ...
        sma = add_state(sma, 'name', 'incorrect_reward', 'self_timer', locked_snd_dur, ...
            ...
            'SoundOut', locked_snd}, ...
            'input_to_statechange', {'Tup', 'err_state'});
        ...
        % Added err_state in the same vein as the regular hit_state ~KJM
        
        sma = add_state(sma, 'name', 'err_state', 'self_timer', min_time, ...
            'output_actions', {'SchedWaveTrig', 'hitstatetimer'}, ...
            'input_to_statechange', {'Tup', 'current_state+2'});
        sma = add_state(sma, 'self_timer', min_time, ...
            'output_actions', {'SchedWaveTrig', 'hitstatetimer'}, ...
        ...
        dispatcher('send_assembler', sma, {'hit_state', 'err_state', 'error_state', 'violation_state'});
