...
%% init
  case 'init',
    ...
    ToggleParam(obj, 'LeftRightOnly', 0, x, y, 'position', [pos(3)-150 pos(4)-180 100 20], ...
...
%% next_trial
  case 'next_trial',
    ...
    [this_stim] = StimulatorSection(obj, 'next_trial');
...
%% update_trial_info
  case 'update_trial_info'
    ...
    if n_done_trials == 0,
        ...
        previous_stims.value   = value(ThisStim);
    elseif n_done_trials > 0,
        ...
        previous_stims.value   = [previous_stims(:); value(ThisStim)];
	end
