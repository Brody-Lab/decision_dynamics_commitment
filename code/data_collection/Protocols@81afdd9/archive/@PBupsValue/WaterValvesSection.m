...
% Tweaked by KJM Jan 2012 to make valveTime = 0 when volume requested = 0
...
switch action
    case 'init',
        ...
        EditParam(obj,'Left_volume',     24,x,y,'position',[x    y  90 20],'labelfraction',0.5, 'label','Left uL');
        ...
        EditParam(obj,'Center_volume',   24,x,y,'position',[x    y  90 20],'labelfraction',0.5, 'label','Center uL');
        ...
        EditParam(obj,'Right_volume',    24,x,y,'position',[x    y  90 20],'labelfraction',0.5, 'label','Right uL');
