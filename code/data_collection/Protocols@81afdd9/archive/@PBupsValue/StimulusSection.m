...
%% init    
  case 'init',
      ...
      ToggleParam(obj, 'fixed_nic', 1, x, y, ...
             'OffString', 'Fixed Stim start delay', ...
             'OnString', 'Fixed Nose-in-center', ...
             'TooltipString', 'If fixed stim start delay, stim_start_delay is fixed and nose_in_center allowed to vary. \nIf fixed nose-in-center, nose_in_center is fixed and stim_start_delay is allowed to vary');
...
%% next_trial
  case 'next_trial',      
      ...
      elseif ~value(fixed_nic)
          nose_in_center.value = max(0, stim_start_delay + fixed_stim_dur);
      else
