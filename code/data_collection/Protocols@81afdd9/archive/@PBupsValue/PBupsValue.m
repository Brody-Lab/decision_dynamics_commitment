% PBups protocol
% BWB, February 2009
% Modified for value-based feedback Jan 2012 by KJM

function [obj] = PBupsValue(varargin)
...
%% init
  case 'init'
    ...
    set(value(myfig), 'Position', [400 100 850 750]);
    ...
    next_row(y);
    % stimulator output to power an implanted LED, where available
    % added April 2011, BWB
