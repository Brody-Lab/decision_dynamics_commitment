...
obj = class(struct, mfilename, saveload, water, wateradaptor, ...
    ...
    distribui, poissonbups3, comments, sqlsummary);
...
%% init
  case 'init'
    ...
    % frozen stimuli initialization stuff
...
%     disp('Beginning pre_saving_settings')
    PBupsSection(obj,'eod_stuff');
%     disp('Successfully called eod_stuff')
