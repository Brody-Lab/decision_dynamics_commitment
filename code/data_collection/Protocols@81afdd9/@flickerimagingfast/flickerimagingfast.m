...
% BBS Feb 2013
% modified for transgenics, new Bezos scop, Jan 2016, cmc and bbs

function [obj] = flickerimagingfast(varargin)
...
switch action,
   ...
   case 'init'
      ...
      HeaderParam(obj, 'prot_title', ['flickerimagingfast: ' expmtr ', ' rname], ...
         x, y, 'position', [10 figpos(4)-25, 800 20]);
      
      flickerimagingfast(obj, 'prepare_next_trial');
