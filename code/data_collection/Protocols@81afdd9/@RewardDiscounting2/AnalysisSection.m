...
%% init  
  case 'init',
    ...
    SoloParamHandle(obj, 'LearningStageCounter','value',0,'save_with_settings',1);
    SoloParamHandle(obj, 'FreeTrialCounter',    'value',0,'save_with_settings',0);
    
    SoloParamHandle(obj, 'Free_Trial_Counter',  'value',0,'save_with_settings',1);
    SoloParamHandle(obj, 'Forced_Trial_Counter','value',0,'save_with_settings',1);
    
    SoloParamHandle(obj, 'Exps',                'value',0,'save_with_settings',1);
    SoloParamHandle(obj, 'Count',               'value',0,'save_with_settings',1);
    SoloParamHandle(obj, 'Current',             'value',0,'save_with_settings',1);
    SoloParamHandle(obj, 'DayCount',            'value',0,'save_with_settings',1);
