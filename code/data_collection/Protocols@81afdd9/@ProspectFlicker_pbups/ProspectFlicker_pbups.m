%ProspectFlicker_pbups, cmc 2/6/16

function [obj] = ProspectFlicker_pbups_pbups(varargin)
...
switch action,
   ...
   case 'init'
      ...
      HeaderParam(obj, 'prot_title', ['ProspectFlicker_pbups: ' expmtr ', ' rname], ...
         x, y, 'position', [10 figpos(4)-25, 800 20]);
      
      
    %  SMA1(obj, 'init');
     
      ProspectFlicker_pbups(obj, 'prepare_next_trial');
