...
switch action
    ...
    case 'stage1',
        ...
        %% States setup
        % The first state is just waiting for the rat to not poke in the center
        % port.  
    ...
    case 'stage2',
        ...
        sma = add_state(sma,'name','cpoke1','self_timer',postcue_dur,...
        ...
        sma = add_state(sma,'name','wait_for_cout',...
            'self_timer',wait_for_cout_timeout,...
