% FrequencyTask protocol
% Marino Pagan, January 2018

function [obj] = FrequencyTask(varargin)
...
switch action,
    ...
    case 'init'
        ...
        set(value(myfig), 'Position', [400 100 450 570]);       
        ...
        HeaderParam(obj, 'prot_title', ['FrequencyTask: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-20, 807 20]);

    
        %   OK, start preparing the first trial
        FrequencyTask(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['FrequencyTask - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
