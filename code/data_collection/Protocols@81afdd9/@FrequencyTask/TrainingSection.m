...
switch action,
    ...
    case 'init'
        ...
        MenuParam(obj, 'training_stage', {'Stage grow NIC'}, 1, x, y, ...
...
%             case 'Stage 1', 
%                 stage_explanation.value=sprintf('freq only: progressively grow NIC');                
%                 %%% updated only on the first trial
%                 if(value(nTrials_stage)==0)             
%                     %%% direction task parameters
%                     stimulus_mixing_dir.value=1;
%                     stimulus_mixing_dir.value=1;
%                     gamma_dir_values_dir.value=0;
%                     gamma_freq_values_dir.value=4;
