...
% Modified by Diksha Gupta, April 2019 to add a delay after the click ends and more expansive stimulation settings

function [obj] = PBupsDelay(varargin)
...
obj = class(struct, mfilename, saveload, water, ...
    ...
    distribui, poissonbups2, comments, sqlsummary, AdLibGUI, cerebro);
...
%% init
  case 'init'
    ...
    set(value(myfig), 'Position', [400 100 850 780]);
    ...
    HeaderParam(obj, 'prot_title', ['PBupsDelay: ' expmtr ', ' rname], ...
