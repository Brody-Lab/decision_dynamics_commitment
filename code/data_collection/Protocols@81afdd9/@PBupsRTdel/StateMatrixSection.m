...
%% set up sounds
    ...
    MaskSpecs = PBupsSection(obj, 'get_mask_specs');
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %%%%%%%%% NON REACTION TIME STATE MATRIX %%%%%%%%%%%%%%%%%%%%%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        [LeftWValveTime RightWValveTime] = WaterValvesSection(obj, 'get_water_times', hit_streak);
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%  %%%%%%%% REACTION TIME STATE MATRIX %%%%%%%% %%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % This section has a reduced state matrix beacuse animals ever
            % enter this after they have been trained - getting rid of a lot of
            % different punisments, NIC options, etc.
...
% set water volume for RT version of volumes task
    for delt = 1:20
        WaterValvesSection(obj, 'set_water_amounts', 24*tanh(0.06*delt) + left_wtr_offset , 24*tanh(0.06*delt) + right_wtr_offset);
        [LeftWValveTime RightWValveTime] = WaterValvesSection(obj, 'get_water_times', hit_streak);
        waterdisptime(delt,1) = LeftWValveTime;
        waterdisptime(delt,2) = RightWValveTime;
     end

     waterdisptime

% Importing state transition times and rewarded side    
    rewardtup = value(CPokeTup);
    rewside = value(RewSideRT);
            

%% Dont turn on any side LEDs
    side_led = 0;
...
%% wait for center poke 1                          
     ...
     sma = add_state(sma, 'name', 'wait_for_cpoke1', 'self_timer', wait_for_cpoke1_tout, ...
         'output_actions', {'DOut', pre_cpoke_led}, ...
         'input_to_statechange', {'Tup', poke_state; ...
                                  'Cin', center_poke_state; ...
                                  'Lin', poke_state; ...
                                  'Rin', poke_state; ...
                                 });
...
%% set up cpokes1
    ...
    sma = add_state(sma, 'self_timer', rewardtup(1), ...
                'output_actions', {'DOut',          cpoke_led}, ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', 'violation_state'});
            
    sma = add_state(sma, 'self_timer', rewardtup(2), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{2}});
    
    sma = add_state(sma, 'self_timer', rewardtup(3), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{3}});
            
    sma = add_state(sma, 'self_timer', rewardtup(4), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{4}});
            
    sma = add_state(sma, 'self_timer', rewardtup(5), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{5}});
            
    sma = add_state(sma, 'self_timer', rewardtup(6), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{6}});
            
    sma = add_state(sma, 'self_timer', rewardtup(7), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{7}});
            
    sma = add_state(sma, 'self_timer', rewardtup(8), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{8}});
            
    sma = add_state(sma, 'self_timer', rewardtup(9), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{9}});
            
    sma = add_state(sma, 'self_timer', rewardtup(10), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{10}});
            
    sma = add_state(sma, 'self_timer', rewardtup(11), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{11}});
            
    sma = add_state(sma, 'self_timer', rewardtup(12), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{12}});
            
    sma = add_state(sma, 'self_timer', rewardtup(13), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{13}});
            
    sma = add_state(sma, 'self_timer', rewardtup(14), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{14}});
            
    sma = add_state(sma, 'self_timer', rewardtup(15), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{15}});
            
    sma = add_state(sma, 'self_timer', rewardtup(16), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{16}});
            
    sma = add_state(sma, 'self_timer', rewardtup(17), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{17}});
            
    sma = add_state(sma, 'self_timer', rewardtup(18), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{18}});
            
    sma = add_state(sma, 'self_timer', rewardtup(19), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{19}});
            
    sma = add_state(sma, 'self_timer', rewardtup(20), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{20}});
            
    sma = add_state(sma, 'self_timer', rewardtup(21), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{21}});
            
    sma = add_state(sma, 'self_timer', rewardtup(22), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{22}});
            
    sma = add_state(sma, 'self_timer', rewardtup(23), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{23}});
            
    sma = add_state(sma, 'self_timer', rewardtup(24), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{24}});
            
    sma = add_state(sma, 'self_timer', rewardtup(25), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{25}});
            
    sma = add_state(sma, 'self_timer', rewardtup(26), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{26}});
            
    sma = add_state(sma, 'self_timer', rewardtup(27), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{27}});
            
    sma = add_state(sma, 'self_timer', rewardtup(28), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{28}});
            
    sma = add_state(sma, 'self_timer', rewardtup(29), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{29}});
            
    sma = add_state(sma, 'self_timer', rewardtup(30), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{30}});
            
    sma = add_state(sma, 'self_timer', rewardtup(31), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{31}});
            
    sma = add_state(sma, 'self_timer', rewardtup(32), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{32}});
            
    sma = add_state(sma, 'self_timer', rewardtup(33), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{33}});
            
    sma = add_state(sma, 'self_timer', rewardtup(34), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{34}});
            
    sma = add_state(sma, 'self_timer', rewardtup(35), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{35}});
            
    sma = add_state(sma, 'self_timer', rewardtup(36), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{36}});
            
    sma = add_state(sma, 'self_timer', rewardtup(37), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{37}});
            
    sma = add_state(sma, 'self_timer', rewardtup(38), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{38}});
            
    sma = add_state(sma, 'self_timer', rewardtup(39), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{39}});
            
    sma = add_state(sma, 'self_timer', rewardtup(40), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{40}});
            
    sma = add_state(sma, 'self_timer', rewardtup(41), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{41}});
            
    sma = add_state(sma, 'self_timer', rewardtup(42), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{42}});
            
    sma = add_state(sma, 'self_timer', rewardtup(43), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{43}});
            
    sma = add_state(sma, 'self_timer', rewardtup(44), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{44}});
            
    sma = add_state(sma, 'self_timer', rewardtup(45), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{45}});
            
    sma = add_state(sma, 'self_timer', rewardtup(46), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{46}});
            
    sma = add_state(sma, 'self_timer', rewardtup(47), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{47}});
            
    sma = add_state(sma, 'self_timer', rewardtup(48), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{48}});
            
    sma = add_state(sma, 'self_timer', rewardtup(49), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{49}});
            
    sma = add_state(sma, 'self_timer', rewardtup(50), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{50}});
            
    sma = add_state(sma, 'self_timer', rewardtup(51), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{51}});
            
    sma = add_state(sma, 'self_timer', rewardtup(52), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{52}});
            
    sma = add_state(sma, 'self_timer', rewardtup(53), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{53}});
            
    sma = add_state(sma, 'self_timer', rewardtup(54), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{54}});
            
    sma = add_state(sma, 'self_timer', rewardtup(55), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{55}});
            
    sma = add_state(sma, 'self_timer', rewardtup(56), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{56}});
            
    sma = add_state(sma, 'self_timer', rewardtup(57), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{57}});
            
    sma = add_state(sma, 'self_timer', rewardtup(58), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{58}});
            
    sma = add_state(sma, 'self_timer', rewardtup(59), ...
                'input_to_statechange', {'Tup', 'current_state+1';...
                'Cout', rewside{59}}); 
                             

       
%% WAIT_FOR_SPOKE_R states for each delta click value
    
    % if the animal left at 0 delta clicks both left and right side responses are errors  - changing this       
    sma = add_state(sma, 'name', 'wait_for_spoker_0', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_0'}); 

    sma = add_state(sma, 'name', 'wait_for_spoker_1', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_1'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_2', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_2'});                     
                
    sma = add_state(sma, 'name', 'wait_for_spoker_3', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_3'});              

    sma = add_state(sma, 'name', 'wait_for_spoker_4', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_4'});  
 
    sma = add_state(sma, 'name', 'wait_for_spoker_5', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_5'});       

    sma = add_state(sma, 'name', 'wait_for_spoker_6', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_6'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_7', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_7'});    

    sma = add_state(sma, 'name', 'wait_for_spoker_8', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_8'});                    

    sma = add_state(sma, 'name', 'wait_for_spoker_9', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_9'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_10', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_10'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_11', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_11'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_12', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_12'});                     
                
    sma = add_state(sma, 'name', 'wait_for_spoker_13', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_13'});              

    sma = add_state(sma, 'name', 'wait_for_spoker_14', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_14'});  
 
    sma = add_state(sma, 'name', 'wait_for_spoker_15', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_15'});       

    sma = add_state(sma, 'name', 'wait_for_spoker_16', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_16'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_17', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_17'});    

    sma = add_state(sma, 'name', 'wait_for_spoker_18', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_18'});                    

    sma = add_state(sma, 'name', 'wait_for_spoker_19', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_19'});  

    sma = add_state(sma, 'name', 'wait_for_spoker_20', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'error_state1'; ...
                'Rhi', 'right_reward_20'});  
...
%% WAIT_FOR_SPOKE_L states for each delta click value

   sma = add_state(sma, 'name', 'wait_for_spokel_0', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_0'}); 
    
    sma = add_state(sma, 'name', 'wait_for_spokel_1', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_1'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_2', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_2'});                     
                
    sma = add_state(sma, 'name', 'wait_for_spokel_3', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_3'});              

    sma = add_state(sma, 'name', 'wait_for_spokel_4', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_4'});  
 
    sma = add_state(sma, 'name', 'wait_for_spokel_5', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_5'});       

    sma = add_state(sma, 'name', 'wait_for_spokel_6', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_6'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_7', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_7'});    

    sma = add_state(sma, 'name', 'wait_for_spokel_8', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_8'});                    

    sma = add_state(sma, 'name', 'wait_for_spokel_9', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_9'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_10', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_10'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_11', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_11'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_12', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_12'});                     
                
    sma = add_state(sma, 'name', 'wait_for_spokel_13', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_13'});              

    sma = add_state(sma, 'name', 'wait_for_spokel_14', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_14'});  
 
    sma = add_state(sma, 'name', 'wait_for_spokel_15', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_15'});       

    sma = add_state(sma, 'name', 'wait_for_spokel_16', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_16'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_17', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_17'});    

    sma = add_state(sma, 'name', 'wait_for_spokel_18', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_18'});                    

    sma = add_state(sma, 'name', 'wait_for_spokel_19', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_19'});  

    sma = add_state(sma, 'name', 'wait_for_spokel_20', ...
                'output_actions', {'SchedWaveTrig', waves_off; 'SoundOut', -StimulusSpecs.sound_id; ...
                 'DOut', side_led}, ...
                'input_to_statechange', {'Rhi', 'error_state1'; ...
                'Lhi', 'left_reward_20'});  
...
%% Reward states RIGHT REWARD

    sma = add_state(sma, 'name', 'right_reward_0', 'self_timer', min_time, ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'right_reward_1', 'self_timer', waterdisptime(1,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'right_reward_2', 'self_timer', waterdisptime(2,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'right_reward_3', 'self_timer', waterdisptime(3,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_4', 'self_timer', waterdisptime(4,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});    

    sma = add_state(sma, 'name', 'right_reward_5', 'self_timer', waterdisptime(5,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'right_reward_6', 'self_timer', waterdisptime(6,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'right_reward_7', 'self_timer', waterdisptime(7,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_8', 'self_timer', waterdisptime(8,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'right_reward_9', 'self_timer', waterdisptime(9,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_10', 'self_timer', waterdisptime(10,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'right_reward_11', 'self_timer', waterdisptime(11,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'right_reward_12', 'self_timer', waterdisptime(12,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'right_reward_13', 'self_timer', waterdisptime(13,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_14', 'self_timer', waterdisptime(14,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});    

    sma = add_state(sma, 'name', 'right_reward_15', 'self_timer', waterdisptime(15,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'right_reward_16', 'self_timer', waterdisptime(16,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'right_reward_17', 'self_timer', waterdisptime(17,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_18', 'self_timer', waterdisptime(18,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'right_reward_19', 'self_timer', waterdisptime(19,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'right_reward_20', 'self_timer', waterdisptime(20,2), ...
                'output_actions', {'DOut', right1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 


%% Reward states LEFT REWARD

    sma = add_state(sma, 'name', 'left_reward_0', 'self_timer', min_time, ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'left_reward_1', 'self_timer', waterdisptime(1,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'left_reward_2', 'self_timer', waterdisptime(2,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'left_reward_3', 'self_timer', waterdisptime(3,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_4', 'self_timer', waterdisptime(4,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});    

    sma = add_state(sma, 'name', 'left_reward_5', 'self_timer', waterdisptime(5,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'left_reward_6', 'self_timer', waterdisptime(6,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'left_reward_7', 'self_timer', waterdisptime(7,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_8', 'self_timer', waterdisptime(8,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'left_reward_9', 'self_timer', waterdisptime(9,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_10', 'self_timer', waterdisptime(10,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'left_reward_11', 'self_timer', waterdisptime(11,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'left_reward_12', 'self_timer', waterdisptime(12,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'left_reward_13', 'self_timer', waterdisptime(13,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_14', 'self_timer', waterdisptime(14,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});    

    sma = add_state(sma, 'name', 'left_reward_15', 'self_timer', waterdisptime(15,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});

    sma = add_state(sma, 'name', 'left_reward_16', 'self_timer', waterdisptime(16,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});     

    sma = add_state(sma, 'name', 'left_reward_17', 'self_timer', waterdisptime(17,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_18', 'self_timer', waterdisptime(18,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'}); 

    sma = add_state(sma, 'name', 'left_reward_19', 'self_timer', waterdisptime(19,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                

    sma = add_state(sma, 'name', 'left_reward_20', 'self_timer', waterdisptime(20,1), ...
                'output_actions', {'DOut', left1water}, ...
                'input_to_statechange', {'Tup', 'hit_state'});                 
...
%% hit states
    ...
    % so that history section can parse data
    sma = add_state(sma, 'name', 'hit_state', 'self_timer', DrinkTime, ...
          'input_to_statechange', {'Tup', 'clean_up_state'});
