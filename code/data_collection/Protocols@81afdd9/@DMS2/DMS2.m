...
switch action
    ...
    case 'init'
        ...
        SoloParamHandle(obj, 'active_curricula', 'value',...
            {'JB_r_spoke_starter';'JB_cpoke_test';'JB_r_classic';'JB_r_classic_pro_anti';});
...
%         next_row(y);
        ...
        HeaderParam(obj, 'prot_title', ['DMS2 v1.5.1: ' expmtr ', ' rname], 0, 683);
    ...
    case 'prepare_next_trial'
        ...
        if n_done_trials == 1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value = ['DMS2 v1.6.0 - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
