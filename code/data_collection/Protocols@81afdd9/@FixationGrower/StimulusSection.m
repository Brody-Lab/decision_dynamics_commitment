% Stimulus Section
% 
% Back bone is a Delayed Match to Sample task. However, could be extended
% in different directions. If stimuli are set to off- effectively not in
% use!
% 
% Edited by Jess Breda July 2024
%
% Goal:
...
switch action
    ...
    case 'init'
        ...
        set(value(pairsfig), 'position', [.3 .8 .15 .15]);
        ...
        training_section_vars = {'stim_values', 'stimulus_type', 'rule', 'stimuli_on',...
            'presets', 'sb_extra', 'volume_multiplier'};
    ...
    case 'prepare_next_trial'
        if stimuli_on
            ...
            current_sa.value = nan;
            current_sb.value = nan;
        end
    ...
    case 'update_performance'
        ...
        otherwise
            error(sprintf('FixationGrower/StimulusSection/update_performance: Invalid result: %d', result))
        end
    ...
    otherwise
        warning('FixationGrower/StimulusSection - Unknown action: %s\n', action);
