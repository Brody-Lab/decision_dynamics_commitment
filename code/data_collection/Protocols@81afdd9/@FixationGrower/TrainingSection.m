...
% 
% Copied from DMS2 and modified to remove additional variables in July 2024
%
% Case Info:
%       init : 
...
%         curriculum_folder = 'C:\ratter\Protocols\@FixationGrower\curricula';
%         if ~isfolder(curriculum_folder); addpath(curriculum_folder); end
       ...
       next_row(y,1);
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % active_curricula is located in FixationGrower.m init
        ...
        %% Fixation Experiments
            % none 
            % 
            % V1 - typical way of growing nose poke in the Brody lab- start
            % low, penalty early and grow within a session
            %
            % V2 - JRB way of growing nose poke - start high, penalty late
            % and grow overnight
        MenuParam(obj, 'fixation_experiment_condition', {'none'; 'V1';'V2';},...
        ...
        training_section_send_out_vars = get_name(get_sphandle('owner', '@FixationGrower', 'funcowner', 'TrainingSection'));
    ...
    otherwise
        warning('FixationGrower/TrainingSection - Unknown action: %s\n', action);
