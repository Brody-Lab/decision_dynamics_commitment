...
switch action
    ...
    case 'init',
        ...
        ToggleParam(obj, 'betaRampup', 1, x, y, 'position', [x+100, y, 100, 20], ...
            'label', 'Beta Ramp', ...
        ...
        ToggleParam(obj, 'antibias_toggle', 1, x, y, 'position', [x y 100 20],...
            'OnString', 'AntiB ON', 'OffString', 'Antib OFF', 'TooltipString',...
        ...
        for i = 1:numel(value(active_curricula))
            ...
            function_call = sprintf("SoloFunctionAddVars('TS_%s', 'rw_args', {'antibias_toggle', 'Beta', 'betaRampup'});", current_curricula );
            eval(function_call);
        end
