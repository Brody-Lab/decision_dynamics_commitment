% TaskSwitch3 protocol
% Marino Pagan, October 2015

function [obj] = TaskSwitch3(varargin)
...
%         getSessID(obj);
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch3: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-25, 800 20]);

    
    
    
        TaskSwitch3(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch3 - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
        end
