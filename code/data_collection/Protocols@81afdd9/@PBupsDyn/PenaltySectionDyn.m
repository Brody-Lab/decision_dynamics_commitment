...
function [x, y] = PenaltySectionDyn(obj, action, x, y)
...
%% init
  case 'init',
    ...
    SoloParamHandle(obj, 'mypfig', 'saveable', 0, 'value', ...
        double(figure('position', [409   316   420   650], ...
            'MenuBar', 'none',  ...
            'NumberTitle', 'off', ...
    ...
    NumeditParam(obj, 'SoftDrinkCap', 5, x, y, 'position', [x+100 y 100 20], ...
    ...
    % start subpanel
      ...
      SoloParamHandle(obj, 'WarningSoundPanelFigure', 'saveable', 0, 'value', double(figure('Position', [120 120 430 156])));
    ...
    SoloFunctionAddVars('StateMatrixSectionDyn', 'ro_args', {'DrinkTime', 'WarnDur', 'DangerDur'});
