...
function [x, y] = StimulatorSectionDyn(obj, action, varargin)
...
%% init    
  case 'init',
      ...
      next_row(y);
      SubheaderParam(obj, 'title', 'StimulatorSectionDyn', x, y);
      
      SoloFunctionAddVars('StateMatrixSectionDyn', 'ro_args', ...
          {'nStims'; 'ThisStim'; 'stim_pre'; 'stim_dur'});
      
      SoloFunctionAddVars('SidesSectionDyn', 'ro_args', ...
          {'ThisStim'});
