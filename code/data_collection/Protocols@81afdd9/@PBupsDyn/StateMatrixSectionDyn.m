% @PBupsDyn/StateMatrixSectionDyn
% Alex Piet, Ahmed El Hady, August 2015
% Modified from PBups by BWB, March 2009
...
function  [] =  StateMatrixSectionDyn(obj, action)
...
%% set up sounds
    ...
    %   pre
    %   dur
	[StimulusSpecs StimulatorSpecs] = StimulusSectionDyn(obj, 'get_stimulus_specs');
    MaskSpecs = PBupsDynSection(obj, 'get_mask_specs');
...
%% set up correct responses
    if SidesSectionDyn(obj, 'get_current_side') == 'l',
...
%% ITI
    ...
    ITI = PenaltySectionDyn(obj, 'get_ITI');
...
%         %This is for a single continuous pulse
...
%% hit states
    ...
    switch SidesSectionDyn(obj, 'get_current_side'),
