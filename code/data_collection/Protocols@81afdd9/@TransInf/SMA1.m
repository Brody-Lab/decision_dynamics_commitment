...
switch action
    ...
    case 'next_trial',
        ...
        D  = SoundManagerSection(obj, 'get_sound_id', 'GoSound');
        E  = SoundManagerSection(obj, 'get_sound_id', 'TimeoutSound');
        
        hitsoundout=SoundManagerSection(obj, 'get_sound_id', 'HitSound');
        ...
        sma = add_scheduled_wave(sma, 'name', 'firstsound', 'preamble', .5,'sustain', .001 );
        sma = add_scheduled_wave(sma, 'name', 'intersound', 'preamble', .8,'sustain', .001 );
