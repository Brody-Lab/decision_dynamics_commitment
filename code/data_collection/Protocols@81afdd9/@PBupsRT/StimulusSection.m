...
%       disable(min_rt);
%       next_row(y);
      DistribInterface(obj, 'add', 'min_rt', x, y, 'Style', ...
		  'gaussian',  'Mu', 0.2, 'Sd', 0.1, ...
          'TooltipString', sprintf(['the stimulus must be on for at least this amount of time before a rat can break NIC and make choice'...
          '\n Earlier broken NICs will lead to a violation'...
          '\n For non-RT task, automatically set to be nic - stim_start_delay']));
      disable(min_rt);
    ...
    % new column
      ...
      SoloFunctionAddVars('StateMatrixSection', 'ro_args', ...
          ...
          'legal_cbreak_rt'; 'min_rt'; 'rt_task';...
      ...
      SoloFunctionAddVars('SidesSection', 'ro_args', {'rt_task', 'min_rt','nose_in_center'});
...
%% next_trial
  case 'next_trial',      
      ...
      if value(rt_task), 
          ...
          legal_cbreak.value = 0;
          fixed_stim_dur.value = 10;
          min_rt.value = DistribInterface(obj, 'get_new_sample', 'min_rt');
      end
...
%% rt_task
  case 'rt_task' 
      ...
      %    enable(min_rt);
          ...
          legal_cbreak_rt.value = 0;
          nose_in_center.value = 0;
          fixed_stim_dur.value = 10;
          PBupsSection_T_min.value = 10;
          stim_start_delay.value = 0;
      else
          enable(stim_timing);
          disable(min_rt);
