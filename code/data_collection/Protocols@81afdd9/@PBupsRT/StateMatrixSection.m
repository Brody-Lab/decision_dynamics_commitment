...
switch action
    ...
    case 'next_trial',
        ...
        if (~rt_task)
            ...
            %% set up correct responses with SidesSection variable: CPokeTup and RewSideRT
            ...
            leftcorrect_side_valvetime = LeftWValveTime*left_wtr_mult;
            rightcorrect_side_valvetime = RightWValveTime*right_wtr_mult;
            
            sma = add_scheduled_wave(sma, 'name', 'direct_rewardL', 'preamble', reward_delay(1), ...
                'sustain', leftcorrect_side_valvetime, 'DOut', left1water);
            
            sma = add_scheduled_wave(sma, 'name', 'direct_rewardR', 'preamble', reward_delay(1), ...
                'sustain', rightcorrect_side_valvetime, 'DOut', right1water);
            ...
            % no more temporary violation state.
            % no waitforcenternoiseout state
            
            sma = add_scheduled_wave(sma, 'name', 'cpoke_timer', 'sustain', legal_cbreak+legal_cbreak_rt+min_time);
            sma = add_happening_spec(sma, struct(...
                'name',                 {'cpoke_timer_hi',                  'cpoke_timer_lo'}, ...
                'detectorFunctionName', {'wave_high',                           'wave_low'}, ...
                'inputNumber',          {get_wavenumber(sma, 'cpoke_timer'), get_wavenumber(sma, 'cpoke_timer')}));
            ...
            % Nose is in: CENTER POKE STATE 1: I can do this by defining two
            % kinds of waitforspoke states one leading to reward on the left
            % and other leading to reward on right. THIS SHOULD WORK.
            ...
            %% wait for spoke when left poke is the correct choice
            
            sma = add_state(sma, 'name', 'wait_for_spokel_temp', 'self_timer', min_time, ...
                'output_actions', {'SchedWaveTrig', waves_off; ...
                'SoundOut', -StimulusSpecs.sound_id;}, ...
                'input_to_statechange', {'Tup', 'current_state+1'});
            
            sma = add_state(sma, 'name', 'wait_for_spokel', ...
                'output_actions', {'DOut', side_led}, ...
                'input_to_statechange', {'Lhi', 'left_reward'; ...
                'Rhi', 'error_state1'; ...
                });
            
            
            %% wait for spoke when right poke is the correct choice
            sma = add_state(sma, 'name', 'wait_for_spoker_temp', 'self_timer', min_time, ...
                'output_actions', {'SchedWaveTrig', waves_off; ...
                'SoundOut', -StimulusSpecs.sound_id;}, ...
                'input_to_statechange', {'Tup', 'current_state+1'});
            
            sma = add_state(sma, 'name', 'wait_for_spoker', ...
                'output_actions', {'DOut', side_led}, ...
            ...
            % pokesplot
            sma = add_state(sma, 'name', 'left_reward', 'self_timer', locked_snd_dur, ...
                'output_actions', {'SchedWaveTrig', ['direct_rewardL' swaves_to_add]; ...
                'SoundOut', locked_snd}, ...
                'input_to_statechange', {'Tup', 'HIT_STATE'});
            sma = add_state(sma, 'name', 'right_reward', 'self_timer', locked_snd_dur, ...
                'output_actions', {'SchedWaveTrig', ['direct_rewardR' swaves_to_add];
                'SoundOut', locked_snd}, ...
                'input_to_statechange', {'Tup', 'HIT_STATE'});
