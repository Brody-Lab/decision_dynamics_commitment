% TaskSwitch4repeat protocol
% Marino Pagan, October 2015

function [obj] = TaskSwitch4repeat(varargin)
...
switch action,
    ...
    case 'init'
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch4repeat: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-20, 807 20]);

    
        %   OK, start preparing the first trial
        TaskSwitch4repeat(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch4repeat - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
