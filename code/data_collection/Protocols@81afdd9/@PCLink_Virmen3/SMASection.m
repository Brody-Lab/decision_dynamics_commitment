...
switch action
    ...
    case 'prepare_next_trial'
        ...
        sma = add_state(sma, 'name', 'wait1', 'self_timer',0.3, ...
            ...
            'input_to_statechange', { 'Tup', 'state_1' });
        
        
        sma = add_state(sma, 'name', 'state_1', ...
            'output_actions', {'PCLink1Out', 2}, ...
            'input_to_statechange', { 'PCLink2_1', 'state_2'
                                      'PCLink2_7', 'final_state'
                                      'PCLink2_8', 'final_state'});
        
         sma = add_state(sma, 'name', 'state_2', ...
            'output_actions', {'DOut', xled, ...
                              'PCLink1Out', 1}, ...
            'input_to_statechange', { 'PCLink2_1', 'state_1'
                                      'PCLink2_7', 'final_state'
                                      'PCLink2_8', 'final_state'});
