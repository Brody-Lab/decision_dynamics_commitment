...
switch action
  case 'init',
    ...
    NumeditParam(obj, 'violation_delay', 0.001, x, y, ...
        'TooltipString', sprintf(['The time (in sec) between center poke exit and the initiation of the violation feedback sound' ...
                                  '\nnote that once the rat has made the answer poke, his response is locked in'])); next_row(y);
    ...
    SoloFunctionAddVars('StateMatrixSection', 'ro_args', ...
		...
		'error_delay'; 'locked_in_sound'; 'violation_delay';...
