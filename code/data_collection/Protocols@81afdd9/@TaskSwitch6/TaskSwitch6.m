% TaskSwitch6 protocol
% Marino Pagan, October 2015

function [obj] = TaskSwitch6(varargin)
...
switch action,
    ...
    case 'init'
        ...
        set(value(myfig), 'Position', [400 10 850 700]);       
...
% y=5; next_column(x); 
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch6: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-20, 807 20]);

    
        %   OK, start preparing the first trial
        TaskSwitch6(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
        ...
        %%% set up opto for next trial
        OptoSection(obj, 'next_trial');
        ...
        if n_done_trials==1
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch6 - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
