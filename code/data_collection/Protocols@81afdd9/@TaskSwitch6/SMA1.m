...
%         
        ...
        sma = add_state(sma,'name','wait_for_cpoke',...
            'self_timer',1,...
            'input_to_statechange',{'Tup','wait_for_cpoke_wait2'}); %wait for poke out
                
        
        sma = add_state(sma,'name','wait_for_cpoke_wait2',...
            'self_timer',min_time,...
            'input_to_statechange',{'Clo',wait_for_cpoke2}); %wait for poke out
...
%             'input_to_statechange',{'Tup','hit_state2'});
        ...
        sma = add_state(sma,'name','hit_state2','self_timer',value(reward_delay)+hit_valve_time+0.5,...
