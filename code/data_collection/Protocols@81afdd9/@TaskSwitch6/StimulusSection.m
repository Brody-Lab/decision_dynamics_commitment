...
switch action,
    ...
    case 'init'
        ...
        ToggleParam(obj, 'randomize_first_task', 0, x, y, 'position', [x y 200 20], ...
            ...
            'TooltipString', 'If on, picks randomly the first task');next_row(y,1);

        
        %%%% repeat stimuli?
        ToggleParam(obj, 'repeat_same_stimuli', 0, x, y, 'position', [x y 200 20], ...
            'OffString', 'No repeat', 'OnString',  'Yes repeat', ...
            'TooltipString', 'If on, fixes stimuli throughout session');next_row(y,1);
        ...
        set(value(myaxesdir),'Position', [.52 .46 .18 .18]);
        ...
        set(value(myaxesfreq),'Position', [.74 .46 .18 .18]);
        ...
        set(value(myaxeshistory0),'Position', [.87 .67 .065 .065]);
        ...
        set(value(myaxeshistory1),'Position', [.775 .67 .065 .065]);
        set(value(myaxeshistory0),'XLim',[0.5 6.5],'YLim',[0.5 6.5]);
        ...
        set(value(myaxeshistory2),'Position', [.68 .67 .065 .065]);
        ...
        set(value(myaxeshistory3),'Position', [.585 .67 .065 .065]);
        ...
        set(value(myaxeshistory4),'Position', [.49 .67 .065 .065]);
        ...
        SoloParamHandle(obj, 'sndz', 'value',[]);        
        SoloParamHandle(obj, 'dataz', 'value',[]);   
        SoloParamHandle(obj, 'gammasdir', 'value',[]);
        SoloParamHandle(obj, 'gammasfreq', 'value',[]);
        SoloParamHandle(obj, 'dataz_index', 'value',0);   
    ...
    case 'next_trial',
        ...
        if(value(repeat_same_stimuli))
            
            gadir=value(gammasdir);
            gafreq=value(gammasfreq);
            z=value(dataz_index);
            aaa=value(sndz);
            bbb=value(dataz);
            
            ind=find(gadir==value(ThisGamma_dir) & gafreq==value(ThisGamma_freq));
            ...
            if(isempty(ind))
                ...
                aaa{z}=snd;
                bbb{z}=data;
                gadir(z)=value(ThisGamma_dir);
                gafreq(z)=value(ThisGamma_freq);
                
                
                sndz.value=aaa;
                dataz.value=bbb;
                dataz_index.value=z;
                gammasdir.value=gadir;
                gammasfreq.value=gafreq;
