% @PWM and @AthenaDelayComp feature a custom filt function for generating
% the pink noise stimuli, which I've copied over below in order to allow
% @PWM2 to use the old stimuli (it generally defaults to using MATLAB's
% `pinknoise` function, instead).
%
% Jorge Yanar, March 2023

function filtsignal=custom_filt(signal,fcut,Fs,filter_type)
