...
%% init
  case 'init',
    ...
    SoloParamHandle(obj, 'mypfig', 'saveable', 0, 'value', ...
        double(figure('position', [409   316   210   500], ...  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            'MenuBar', 'none',  ...
            'NumberTitle', 'off', ...
    ...
    % 210120 sjv combining violation penalties to use the same sound interface since bpod can only handle 20 sounds
...
%     PunishInterface(obj, 'set', 'violation_penalty2', 'SoundsPanel', 0);
    ...
    [x, y] = PunishInterface(obj, 'add', 'violation_penalty', x, y);
    ...
    [x, y] = PunishInterface(obj, 'add', 'timeout_penalty', x, y);
    PunishInterface(obj, 'set', 'timeout_penalty', 'SoundsPanel', 0);
