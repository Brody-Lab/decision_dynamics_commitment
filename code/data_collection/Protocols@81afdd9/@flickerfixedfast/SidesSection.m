            ...
            switch value(training_stage) %#ok<*NODEF>
                ...
                case 1,  % Light chase and grow nose in center
                    ...
                    if ~was_viol  % if last trial was violation don't increment.
                        ...
                        if settling_time<0.25
                            settling_time.value=settling_time+0.05;
                        else
                            delay_time.value=delay_time+0.02;
                        end
                ...
                case 2, % start counting flashes
                    ...
                    if n_done_trials<10 %ramp up over the first 10 trials
                        ...
                        % decreased maximum number of flashes to 5
                        settling_time.value=0.8; %increased settling time for imaging
                        delay_time.value=0.25;
                    end
                    ...
                    elseif trials_in_stage<200
                        nic_time.value=3*bin_size; %modified for more bins
                        if rand>0.5
                            right_prob.value=0.9;
                            left_prob.value=0.1;
                        else
