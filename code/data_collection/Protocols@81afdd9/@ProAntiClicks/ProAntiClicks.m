% ProAntiClicks protocol : version 2 of ProAntiDirectionDG

function [obj] = ProAntiClicks(varargin)
...
switch action
    ...
    case 'init'
        ...
        HeaderParam(obj, 'prot_title', ['ProAntiClicks: ' expmtr ', ' rname], ...
            x, y, 'position', [10 figpos(4)-20, 807 20]);
        
        % OK, start preparing the first trial
        ProAntiClicks(obj, 'prepare_next_trial');
    ...
    case 'prepare_next_trial'
      ...
      if n_done_trials == 1
          [expmtr, rname] = SavingSection(obj, 'get_info');
          prot_title.value = ['ProAntiClicks - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
      end
