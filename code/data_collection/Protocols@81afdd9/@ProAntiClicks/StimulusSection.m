...
switch action
    ...
    case 'init'
        ...
        NumeditParam(obj, 'legal_cbreak', 0.1, x, y, ...
            'labelfraction', 0.4, ...
        ...
        NumeditParam(obj, 'wait_for_cpoke_timeout', 60, x, y, 'label', 'Timeout for cpoke', 'TooltipString', 'Timeout waiting for cpoke');
        next_row(y);
        ...
        SoundInterface(obj,'set','HitSound','Freq1',1000,'Freq2',5000,'Dur1',0.2,'Dur2',0.4,'Tau',0.05);
        ...
        SoloFunctionAddVars('SMA1','ro_args',{'ThisTask';'settling_time';...
            ...
            'total_error_delay';'total_water_multiplier'; 'legal_cbreak'});
