...
switch action,
	...
	case 'init'
		...
		SoloParamHandle(obj, 'error_rate', 'value', []);
        ...
        DispParam(obj, 'error_rate', 0, x, y, 'TooltipString', ...
	...
	case 'evaluate'
        ...
        switch value(training_stage)
            case 0,                  %%  center led on -> poke in the center -> go cue -> reward light and sound
                if n_done_trials > 1,
		...
		if nargout > 0,
			x = [n_done_trials, value(violation_rate), value(error_rate), value(Left_hit_frac), ...
