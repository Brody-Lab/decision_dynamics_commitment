...
switch action,
    ...
    case 'init'
        ...
        next_column(x);
        y=5;
		NumeditParam(obj,'generalization',0,x,y,'label','Some Trials are rewarded at random');
		next_row(y);
        ...
        SoloFunctionAddVars('SMA1', 'ro_args', ...
            ...
            'wait_for_spoke_timeout' ; 'reward_delay';'reward_exponent';'left_wtr_mult';...
				'error_iti';'violation_iti';'right_wtr_mult';'antibias_wtr_mult';'generalization'});
        ...
        if use_training==1
            ...
            switch value(training_stage) %#ok<*NODEF>
                ...
                case 2, % start counting flashes
                   ...
                   % Have exponential blocks of left and right trials to make it
                   % easier!
                   if rand<0.35
          ...
          %1/16/15 moving rats to a max 3 bin version 'stage 4'BBS
                       % training_stage.value=4;
%3/12/15 rats no longer go to the low bin stage 4 BBS
                        Ps=[0.3 0.7;
                            0.7 0.3;
                            0.2  0.7
                            0.7  0.2;
