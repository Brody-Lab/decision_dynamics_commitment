% flickrMarino protocol
% JCE,BBS July 2012
% MP June 2015

function [obj] = flickrMarino(varargin)
...
switch action,
   ...
   case 'init'
      ...
      HeaderParam(obj, 'prot_title', ['flickrMarino: ' expmtr ', ' rname], ...
         x, y, 'position', [10 figpos(4)-25, 800 20]);
      
      flickrMarino(obj, 'prepare_next_trial');
   ...
   case 'prepare_next_trial'
    ...
    %  TrainingSection(obj, 'next_trial');
      ...
      if n_done_trials==1
      [expmtr, rname]=SavingSection(obj, 'get_info');
      prot_title.value=['FlickrMarino - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
      end
      SMA1(obj,'next_trial');
