% TaskSwitch4new protocol
% Marino Pagan, April 2017

function [obj] = TaskSwitch4new(varargin)
...
%         next_row(y,-0.4);                
        ...
        HeaderParam(obj, 'prot_title', ['TaskSwitch4new: ' expmtr ', ' rname], ...
        x, y, 'position', [10 figpos(4)-20, 807 20]);

    
        %   OK, start preparing the first trial
        TaskSwitch4new(obj, 'prepare_next_trial');
...
%             AdLibGUISection(obj, 'set_first_trial_time_stamp');
            [expmtr, rname]=SavingSection(obj, 'get_info');
            prot_title.value=['TaskSwitch4new - on rig ' get_hostname ' : ' expmtr ', ' rname  '.  Started at ' datestr(now, 'HH:MM')];
        end
